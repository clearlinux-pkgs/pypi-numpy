...
Source0  : https://files.pythonhosted.org/packages/f4/66/17b8e95770478436bf968353c89683ce6f9e14d92e0d4fb3111c09ba18d2/numpy-1.23.2.tar.gz
...
%prep
%setup -q -n numpy-1.23.2
cd %{_builddir}/numpy-1.23.2
%patch1 -p1
%patch3 -p1
%patch4 -p1
%patch5 -p1
pushd ..
cp -a numpy-1.23.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660517421
