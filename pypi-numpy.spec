...
Source0  : https://files.pythonhosted.org/packages/05/35/fb1ada118002df3fe91b5c3b28bc0d90f879b881a5d8f68b1f9b79c44bfe/numpy-2.0.0.tar.gz
...
%prep
%setup -q -n numpy-2.0.0
cd %{_builddir}/numpy-2.0.0
%patch -P 1 -p1
pushd ..
cp -a numpy-2.0.0 buildavx2
popd
pushd ..
cp -a numpy-2.0.0 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721086965
