...
Source0  : https://files.pythonhosted.org/packages/ec/d0/c12ddfd3a02274be06ffc71f3efc6d0e457b0409c4481596881e748cb264/numpy-2.2.2.tar.gz
...
%prep
%setup -q -n numpy-2.2.2
cd %{_builddir}/numpy-2.2.2
%patch -P 1 -p1
pushd ..
cp -a numpy-2.2.2 buildavx2
popd
pushd ..
cp -a numpy-2.2.2 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737389344
