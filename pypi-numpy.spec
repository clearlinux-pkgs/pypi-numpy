...
Source0  : https://files.pythonhosted.org/packages/42/38/775b43da55fa7473015eddc9a819571517d9a271a9f8134f68fb9be2f212/numpy-1.23.5.tar.gz
...
%prep
%setup -q -n numpy-1.23.5
cd %{_builddir}/numpy-1.23.5
%patch1 -p1
%patch2 -p1
pushd ..
cp -a numpy-1.23.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669054485
