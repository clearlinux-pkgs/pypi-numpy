...
Source0  : https://files.pythonhosted.org/packages/0a/88/f4f0c7a982efdf7bf22f283acf6009b29a9cc5835b684a49f8d3a4adb22f/numpy-1.23.3.tar.gz
...
%prep
%setup -q -n numpy-1.23.3
cd %{_builddir}/numpy-1.23.3
%patch1 -p1
%patch2 -p1
pushd ..
cp -a numpy-1.23.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662846620
