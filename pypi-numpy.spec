...
Source0  : https://files.pythonhosted.org/packages/e4/a9/6704bb5e1d1d778d3a6ee1278a8d8134f0db160e09d52863a24edb58eab5/numpy-1.24.2.tar.gz
...
%prep
%setup -q -n numpy-1.24.2
cd %{_builddir}/numpy-1.24.2
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a numpy-1.24.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675636361
