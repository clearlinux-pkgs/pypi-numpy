...
Source0  : https://files.pythonhosted.org/packages/dd/2b/205ddff2314d4eea852e31d53b8e55eb3f32b292efc3dd86bd827ab9019d/numpy-1.26.2.tar.gz
...
%prep
%setup -q -n numpy-1.26.2
cd %{_builddir}/numpy-1.26.2
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a numpy-1.26.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699896607
