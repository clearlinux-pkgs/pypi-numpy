...
Source0  : https://files.pythonhosted.org/packages/25/ca/1166b75c21abd1da445b97bf1fa2f14f423c6cfb4fc7c4ef31dccf9f6a94/numpy-2.1.3.tar.gz
...
%prep
%setup -q -n numpy-2.1.3
cd %{_builddir}/numpy-2.1.3
%patch -P 1 -p1
pushd ..
cp -a numpy-2.1.3 buildavx2
popd
pushd ..
cp -a numpy-2.1.3 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730667093
