...
Source0  : https://files.pythonhosted.org/packages/65/6e/09db70a523a96d25e115e71cc56a6f9031e7b8cd166c1ac8438307c14058/numpy-1.26.4.tar.gz
...
%prep
%setup -q -n numpy-1.26.4
cd %{_builddir}/numpy-1.26.4
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a numpy-1.26.4 buildavx2
popd
pushd ..
cp -a numpy-1.26.4 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708443466
