...
Source0  : https://files.pythonhosted.org/packages/4b/d1/8a730ea07f4a37d94f9172f4ce1d81064b7a64766b460378be278952de75/numpy-2.1.2.tar.gz
...
%prep
%setup -q -n numpy-2.1.2
cd %{_builddir}/numpy-2.1.2
%patch -P 1 -p1
pushd ..
cp -a numpy-2.1.2 buildavx2
popd
pushd ..
cp -a numpy-2.1.2 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728428578
