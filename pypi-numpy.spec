...
Source0  : https://files.pythonhosted.org/packages/dc/b2/ce4b867d8cd9c0ee84938ae1e6a6f7926ebf928c9090d036fc3c6a04f946/numpy-2.2.5.tar.gz
...
%prep
%setup -q -n numpy-2.2.5
cd %{_builddir}/numpy-2.2.5
%patch -P 1 -p1
pushd ..
cp -a numpy-2.2.5 buildavx2
popd
pushd ..
cp -a numpy-2.2.5 buildavx512
popd
pushd ..
cp -a numpy-2.2.5 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745246444
